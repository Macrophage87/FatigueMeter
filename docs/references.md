...
- 🟡 Bell et al. (2001), *Exp Physiol* 86:667–676. — https://physoc.onlinelibrary.wiley.com/doi/pdf/10.1113/eph8602150 — mono/bi/tri-exponential comparison. *(Paywalled/403; conclusions from abstract, equations via canonical forms.)*
...
- 🟡 Rogers, Fleitas-Paniagua, Trpcic, Zagatto, Murias (2025), durability/TTF, *EJAP* 125(6):1619–1631. — https://doi.org/10.1007/s00421-025-05716-2 — HR/α1/fB drift to task failure; ICC 0.73–0.94. *(Full text paywalled; per-quarter α1 values not obtained.)*
...
- 🟡 Barsumyan et al. (2026), *BMC Sports Sci Med Rehabil* — cadence decline vs drift/decoupling (b=0.61; ~0.6%/rpm). *(Full text not read; from abstract.)*
