...
| `POWER_SANITY_MAX` | Constants.mc `POWER_SANITY_MAX` | 2000 W | — (engineering guard) | Convention | n/a | **Convention / glitch-rejection, NOT a physiological VO2/FTP anchor** — absolute ceiling above any human sprint peak so a real effort is never clipped; rejects sensor spikes before the filter input (#23) |
